...
const faqs = [
  {
    ...
    answer: "Viberyは友達づくりに特化したアプリです。恋愛や性的な出会いを目的とした利用は禁止しており、同性限定のプラットフォームで安心して純粋な友情を育めます。"
  },
  {
    question: "安全性はどのように確保されていますか？",
    answer: "厳格な年齢認証（18歳以上）、同性限定システム、24時間体制の監視、通報機能、不適切なユーザーの即座な排除など、多層的な安全対策を実装しています。"
  },
  {
    question: "匿名性は保たれますか？",
    answer: "ニックネームでの利用が可能で、個人情報の開示は任意です。プライバシーを重視した設計で、安心してコミュニケーションを楽しめます。"
  },
  {
    question: "どのような人が利用していますか？",
    answer: "趣味や価値観を共有できる友達を求める18歳以上の方々が利用しています。学生から社会人まで幅広い年代の方が、純粋な友情を求めて参加しています。"
  },
  {
    question: "利用料金はかかりますか？",
    answer: "基本機能は完全無料でご利用いただけます。広告収益により運営されており、安心してお使いいただけます。"
  }
]
