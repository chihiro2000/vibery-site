...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    return (
      <button
        className={cn(
          "inline-flex items-center justify-center font-medium transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-mono-400 focus:ring-offset-2 focus:ring-offset-mono-950 disabled:opacity-50 disabled:pointer-events-none relative overflow-hidden group active:scale-95 transform hover:scale-[1.02]",
          {
            // Primary - 白背景
            "bg-mono-50 text-mono-950 hover:bg-mono-100 border border-mono-200 shadow-lg hover:shadow-xl rounded-xl":
              variant === "primary",
            // Secondary - グレー背景
