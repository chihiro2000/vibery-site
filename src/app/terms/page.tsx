        ...
        <div className="glass rounded-2xl p-12 lg:p-16">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-16">
              <h2 className="text-3xl font-display font-bold mb-8 text-mono-50">第1条（本規約への同意）</h2>
            ...
            <section className="mb-16">
              <h2 className="text-3xl font-display font-bold mb-8 text-mono-50">第2条（サービス内容）</h2>
              <div className="w-12 h-px bg-mono-700 mb-8"></div>
              <ol className="list-decimal list-inside space-y-4 text-mono-300 text-lg leading-relaxed">
                <li>本サービスは、同性の友達作りを目的としたコミュニケーション・マッチングアプリです。<strong className="text-mono-100 bg-mono-800 px-2 py-1 rounded">恋愛・性的目的による利用は禁止します。</strong></li>
                <li>本サービスは無料で提供され、広告収益により運営されます。</li>
                <li>本サービスでは、ユーザー間のメッセージ機能や位置情報を用いた近隣ユーザー検索等の機能を提供します。</li>
                <li>本サービスは<strong className="text-mono-100 bg-mono-800 px-2 py-1 rounded">18歳以上（高校生を除く）</strong>の方のみ利用可能です。18歳未満の利用が判明した場合、運営者は直ちにアカウントを削除します。</li>
              </ol>
            </section>

            <section className="mb-16">
              <h2 className="text-3xl font-display font-bold mb-8 text-mono-50">第3条（禁止事項）</h2>
              <div className="w-12 h-px bg-mono-700 mb-8"></div>
              <p className="mb-6 text-mono-300 text-lg">以下の行為を禁止します。違反が確認された場合、運営者は予告なくアカウント停止、利用制限、または利用契約の解除等の措置を講じることがあります。</p>
              <ul className="list-disc list-inside space-y-3 text-mono-300 text-lg leading-relaxed">
                ...
                <li><strong className="text-mono-100 bg-mono-800 px-2 py-1 rounded">恋愛・性的な出会いを目的とする行為</strong></li>
            ...
            <section className="mb-16">
              <h2 className="text-3xl font-display font-bold mb-8 text-mono-50">第4条（安全対策と通報）</h2>
              <div className="w-12 h-px bg-mono-700 mb-8"></div>
              <ol className="list-decimal list-inside space-y-4 text-mono-300 text-lg leading-relaxed">
            ...
            <section className="mb-16">
              <h2 className="text-3xl font-display font-bold mb-8 text-mono-50">第5条（プライバシー・個人情報）</h2>
              <div className="w-12 h-px bg-mono-700 mb-8"></div>
              <ol className="list-decimal list-inside space-y-4 text-mono-300 text-lg leading-relaxed">
                <li>運営者は、取得したユーザーの個人情報を、別途定める<strong className="text-mono-100">「プライバシーポリシー」</strong>に従い適切に取り扱います。</li>
                <li>ユーザーは、プライバシーポリシーに同意したうえで本サービスを利用するものとします。</li>
              </ol>
            </section>

            <section className="mb-16">
              <h2 className="text-3xl font-display font-bold mb-8 text-mono-50">第6条（免責事項）</h2>
              <div className="w-12 h-px bg-mono-700 mb-8"></div>
              <ol className="list-decimal list-inside space-y-4 text-mono-300 text-lg leading-relaxed">
            ...
            <section className="mb-16">
              <h2 className="text-3xl font-display font-bold mb-8 text-mono-50">第7条（お問い合わせ）</h2>
              <div className="w-12 h-px bg-mono-700 mb-8"></div>
              <div className="glass p-8 rounded-xl">
                <p className="mb-6 text-mono-300 text-lg">本規約に関するお問い合わせは、以下のメールアドレスまでご連絡ください。</p>
                <p className="text-lg">
